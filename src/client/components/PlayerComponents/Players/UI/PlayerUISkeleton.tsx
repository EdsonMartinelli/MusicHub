  ...
  return (
    <div className="flex flex-row items-center gap-4 animate-pulse w-full h-full">
      <div className="w-1/3 h-full hidden lg:flex items-center gap-4">
        <div className="h-full w-28 min-w-28 bg-indigo-950 p-4 shrink-0" />
        <div className=" w-full flex flex-col gap-1">
          <p className="bg-indigo-950 h-7 rounded-sm" />
          <span className="text-sm bg-indigo-950 h-5 rounded-sm" />
        </div>
      </div>
      ...
      <div
        className="w-full flex flex-col items-center justify-center px-4 
          gap-2 lg:w-1/3"
      >
        <div className="block lg:hidden w-full h-6 bg-indigo-950 max-w-[512px]" />
