...
export default function PlayButtonUI({
  ...
  return (
    <>
      <button
        onClick={onClick}
        className={`w-8 h-8 lg:w-10 lg:h-10 bg-transparent text-orange-700 rounded-full 
        ...
        after:text-white hover:after:w-fit hover:after:h-fit hover:after:bg-zinc-600
