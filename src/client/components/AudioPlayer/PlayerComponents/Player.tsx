...
export default function Player({ song, artist, setNewTime }: PlayerProps) {
  return (
    <div className="flex flex-row items-center gap-4 w-full h-full text-white">
      <div className="w-1/3 h-full hidden xl:flex items-center gap-4">
        ...
        <div className="w-full flex flex-col gap-1 overflow-hidden">
          ...
          <span className="text-sm text-white/70 h-5 ">{artist}</span>
        </div>
      </div>

      <div
        className="w-full flex flex-col items-center justify-center px-4 
        gap-2 mt-8 xl:w-1/3 xl:mt-0"
      >
      ...
      <div className="w-1/3 hidden xl:flex justify-end items-center gap-1 pr-6">
        <div className="w-1/2">
          <VolumeBar />
        </div>
      </div>
