  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        radial:`radial-gradient(circle 350px at calc(50% - 150px) calc(50% + 200px), ${colors.amber[600]}, ${colors.amber[900]}, transparent),
                radial-gradient(circle 350px at calc(50% + 100px) calc(50% - 250px), ${colors.orange[600]}, ${colors.orange[900]}, transparent),
                radial-gradient(circle 380px at calc(50% + 250px) calc(50% + 150px), ${colors.red[600]}, ${colors.red[900]}, transparent)`,
      }
    },
  },
  plugins: [],
